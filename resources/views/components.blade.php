  ...
  <div class="row m-2">
    ...
    <div class="col-md-4 p-3">
      ...
      <div class="form-check">
        ...
        <label data-toggle="tooltip" data-placement="right" title="Populate fake address for quick tests?" class="form-check-label" for="populateFakeAddress">Fake Address (good for quick tests)</label>
      </div>
      <div class="form-check">
