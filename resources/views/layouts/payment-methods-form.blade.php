<form data-bind="submit: submitPaymentMethods" class="mb-2">
  <div class="row">
    ...
    <div class="col-md-12">
      <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Fetch the available payment methods!">Show Payment Methods</button>
    </div>
  </div>
</form>
